% One-page summary of the EHMbrAIn study. Build: latexmk -pdf -outdir=build onepager.tex
...
\twocolumn[{%
\centering
{\LARGE\bfseries The split verdict\par}
{\large What AI actually fixes in engine health monitoring --- and what only sensors can\par}
\vspace{1.5mm}
{\small\itshape One-page summary of \textbf{EHMbrAIn}: AI-based vs.\ traditional EHM,
a pre-registered gas-path-analysis testbed on the CFM56-7B with synthetic ground truth\par}
\vspace{3mm}
}]
