...
(Spearman $\rho{=}0.70$, though under-powered: a physics-free null reaches $0.242$ and the
test gives $p{=}0.085$): it tells an operator which faults their fleet can see and which
