...
\quad same, @70\,\% life & 1064 & 1059 & \emph{tie: $p{=}.41$} \\
90\,\% interval, both conformal (cy) & 2717 & \textbf{2028} & 1.34$\times$ tighter \\
...
similarity-based prognostic (1981${\to}$1118) --- AI still wins ($858$, $p{=}0.002$). Against
that upgraded baseline the win is \emph{late-life only} (a tie at $70\,\%$ of life), and the
interval advantage is $1.34\times$, not $5.9\times$, once the classical side is given the same
conformal calibration --- a wrapper any method can adopt. Both corrections are the project's
own, found by re-auditing its headline numbers.
...
(Spearman $\rho{=}0.70$, though unprovable as tested: $\approx0.24$ of it is the matrix the
bound shares with the estimator, $\approx0.46$ survives without it, and ten directions cannot
reach significance): it tells an operator which faults their fleet can see and which
