...
error real del estimador ---correlación 0,70--- no supera su propio control. Si barajas la
matriz para que no tenga física, todavía sacas 0,24 de media, así que parte de aquel 0,70 era
el acoplamiento. Hay señal real por encima, pero con diez direcciones el test no llega a
significación. Las cifras de \emph{adquisición} que vienen ahora son medidas distintas y no
están afectadas.
