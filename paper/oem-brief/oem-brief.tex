...
true error, $\rho = 0.70$) is real signal but does not clear a physics-free null
($0.24$ median, $p = 0.085$), because the bound and the estimator share one matrix and a rank
test over ten directions cannot separate them. The \emph{acquisition} figures below are
