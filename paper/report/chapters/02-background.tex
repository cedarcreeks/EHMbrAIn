...
\end{equation*}
whose columns ---the two fault signatures--- point in nearly the same direction. Let the truth
...
barely $1.3^{\circ}$, all but indistinguishable --- while the extended gas-path sensors lift
every pair well clear of it. The angle is geometry, not yet a result; whether it translates
