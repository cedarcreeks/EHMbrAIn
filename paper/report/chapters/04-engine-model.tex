...
\code{OD\_max}, throttled by $T_4$), then solves the part-power point at the commanded
fraction (\code{OD\_pt}) ---the same two-point pattern used by the pyCycle reference example.
