...
interpolation simplices span across altitude blocks in raw physical coordinates.
...
---per channel, a regression of $\log Y$ on a polynomial in the log corrected speed plus
$a\log\theta + b\log\delta$--- rather than copied from generic tables. The fitted exponents
