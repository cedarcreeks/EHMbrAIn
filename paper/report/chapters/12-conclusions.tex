...
\begin{tabular}{@{}>{\raggedright\arraybackslash}p{0.30\textwidth}>{\raggedright\arraybackslash}p{0.44\textwidth}>{\raggedright\arraybackslash}p{0.18\textwidth}@{}}
  ...
  Does the certificate survive a physics-free control? & \textbf{Not conclusively}: real
    $\rho=0.697$ against a shuffled-matrix null median $0.242$, but $p=0.085$ --- a rank test
    over ten directions is under-powered. The N-CMAPSS port fails the same control outright
    & \cref{sec:f21-port} \\
