...
(\cref{ch:overcoming}); its first line already replaced the linearized generator's physics
with a differentiable neural twin 13--19$\times$ more faithful (\cref{tab:surrogate}).
