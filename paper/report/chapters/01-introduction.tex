...
(C6), an external reality check (C7), and --- the furthest reach --- a per-engine certificate
of what a diagnosis can honestly know, proven against the truth (C8). Each item below names
...
comparison trustworthy. The next three chapters build the ingredients: the thermodynamic twin
of the engine (\cref{ch:model}), what the data \emph{is} and where it comes from
